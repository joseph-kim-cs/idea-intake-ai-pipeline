"""
Pipeline routes for idea intake processing.
Contains all the pipeline logic extracted from main.py
"""
...
def run_pipeline(input_file, output_file=None, similarity_threshold=0.78, save_intermediate=True, verbose=True):
    """
